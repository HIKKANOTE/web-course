...
1:WebBrowser1.Navigate((extractfilepath(application.ExeName)+'Лекции фаилы\Тема1\Введение в html.htm'));


2:WebBrowser1.Navigate((extractfilepath(application.ExeName)+'Тест HTML\test_1.html'));
end;
end;
