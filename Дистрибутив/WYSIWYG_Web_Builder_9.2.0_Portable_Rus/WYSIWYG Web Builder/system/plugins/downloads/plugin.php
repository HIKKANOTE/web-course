...
function downloads_update($id)
{
   ...
   if ($authorized)
   {
          ...
          isset($_REQUEST['downloads-bullet']))
      {
         ...
         $downloads_folder = mysql_real_escape_string($downloads_folder);
         $downloads_filter = mysql_real_escape_string($downloads_filter);
         $downloads_bullet = mysql_real_escape_string($downloads_bullet);
